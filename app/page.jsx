  ...
  return (
    <div>
      ...
      <section className="relative h-64 sm:h-80 md:h-96 rounded-lg overflow-hidden">
        ...
        <div className="absolute inset-0 bg-primary/70 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-sm sm:text-base md:text-lg text-secondary/90 max-w-2xl mb-4">
            Plataforma humanitaria para documentar, clasificar y visualizar hallazgos forenses relacionados con personas desaparecidas en México.
          </p>
          <Link
            href="/gallery"
      ...
      <section className="mt-8 max-w-3xl mx-auto text-base leading-relaxed">
        ...
        <p className="mb-4">
          Testigo.mx nace para servir como un repositorio seguro y consultable de objetos personales y restos recuperados en
          búsquedas de campo y fosas clandestinas. Su objetivo es apoyar a familiares y colectivos de búsqueda en la difícil
          labor de identificar a sus seres queridos, respetando en todo momento la dignidad de las víctimas.
        </p>
        <p>
          Explora nuestra galería para consultar hallazgos, utiliza los filtros para afinar tu búsqueda y, si formas parte de
          un colectivo, contribuye cargando información de manera ética y responsable.
        </p>
      </section>
    </div>
  );

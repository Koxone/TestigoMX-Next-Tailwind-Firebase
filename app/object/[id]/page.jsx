...
export default function ObjectDetailPage({ params }) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Link href="/gallery" className="text-sm underline text-primary mb-4 inline-block">
        ← Volver a la galería
      </Link>
      <h1 className="text-2xl  mb-4">Detalle del hallazgo</h1>
      <div className="border border-primary/10 bg-muted p-6 rounded-lg flex flex-col sm:flex-row gap-6">
        ...
        <div className="flex-1 text-sm space-y-2">
          <p>
            <strong>Tipo:</strong> {object.type}
          </p>
          <p>
            <strong>Color:</strong> {object.color}
          </p>
          <p>
            <strong>Estado de conservación:</strong> {object.state}
          </p>
          <p>
            <strong>Fecha de hallazgo:</strong> {object.date}
          </p>
          <p>
            <strong>Ubicación aproximada:</strong> {object.location}
          </p>
          <p>
            <strong>Colectivo responsable:</strong> {object.collective}
          </p>
          <p>
            <strong>Número de expediente:</strong> {object.fileNumber || "N/A"}
          </p>
          <p>
            <strong>Descripción:</strong> {object.description}
          </p>
          <p>
            <strong>Notas:</strong> {object.notes}
          </p>
          <div className="mt-4">
            <a
